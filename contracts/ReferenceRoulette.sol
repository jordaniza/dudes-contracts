...
//     uint8[18] private RED_NUMBERS = [1, 3, 5, 7, 9, 12, 14, 16, 18, 19, 21, 23, 25, 27, 30, 32, 34, 36];
//
...
//      */
//     constructor(address _bet_token, address _vrfCoordinator, address _link, bytes32 _keyHash, uint256 _fee)
//         public
//         ERC20("SAKURA_V1", "SV1")
...
//      */
//     function addLiquidity(uint256 amount, uint256 nonce, uint256 expiry, bool allowed, uint8 v, bytes32 r, bytes32 s)
//         public
//     {
...
//                 [uint256(bets[i].betType), uint256(bets[i].value), uint256(bets[i].amount)]
//             );
//         }
//     }
//
